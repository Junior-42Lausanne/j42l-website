...
export function BrowseCaseStudies({
  ...
  useEffect(() => {
    ...
    function handleNativeWheel(event: globalThis.WheelEvent) {
      ...
      const shouldGoPrev = wheelDeltaRef.current < 0;

      const canScrollNext =
        shouldGoNext && activeProjectIndex < filteredProjects.length - 1;

      const canScrollPrev = shouldGoPrev && activeProjectIndex > 0;
    ...
    <section id="browse-case-studies" className={portfolioLayout.section}>
      <div className="grid gap-12 lg:grid-cols-[0.32fr_0.68fr] lg:items-start">
        ...
        <div
          ...
          className="relative min-h-[680px] overscroll-contain lg:min-h-[740px]"
        >
          <DeckHeader
          ...
          <div className="absolute inset-x-0 bottom-0 top-24 cursor-ns-resize">
            <DeckStage
