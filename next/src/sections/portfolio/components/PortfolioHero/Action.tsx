...
export function HeroPrimaryAction({ className ,href, children }: HeroActionProps) {
    return (
        <Link
            href={href}
            className={[
                ...
                "transition duration-500 ease-out hover:-translate-y-0 hover:bg-[#ffad3d]",
...
export function HeroPrimaryForContact({ className ,href, children }: HeroActionProps) {
    return (
        <Link
            href={href}
            className={[
        ...
        >
            ...
            <span className="relative flex items-center transition duration-500 ease-out group-hover:translate-x-0">
                {children}
                <ArrowRight
                    className="ml-41.5 h-4 w-fit transition duration-500 ease-out group-hover:translate-x-1.5"
                    aria-hidden="true"
                />
            </span>
        </Link>
...
export function HeroSecondaryAction({ className ,href, children }: HeroActionProps) {
    return (
        <Link
            href={href}
            className={[
                "group relative inline-flex h-12 items-center gap-3 text-sm font-semibold text-white/76",
        ...
        >
            <span>{children}</span>
            <ArrowRight
                className="h-4 w-4 opacity-50 transition duration-500 ease-out group-hover:translate-x-1.5 group-hover:opacity-100"
                aria-hidden="true"
            />
        </Link>
    );
