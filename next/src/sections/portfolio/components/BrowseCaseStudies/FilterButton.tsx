        ...
        >
            <div className="mb-12 grid gap-8 lg:grid-cols-[0.72fr_0.78fr] lg:items-end">
                ...
                <div className="max-w-xl lg:justify-self-end">
                    <p className={portfolioText.body}>
                        Explore selected projects by service category. Each case
                        opens into a deeper study of the work, the system and the
                        outcome.
                    </p>
            ...
            <AnimatePresence mode="wait" initial={false}>
                <motion.div
                    ...
                    animate="visible"
                    exit="exit"
                    className="grid gap-5 lg:grid-cols-[1.18fr_0.82fr]"
                >
